  ...
  return (
    <div className="mt-3 sm:mt-5 p-20">
      ...
      <div className="mt-2 mb-6">
        ...
        <p>1. If you and your partner park in the <strong>same spot</strong>, you will incur <strong>a penalty cost of 10.</strong></p>
        ...
        <p>In other words, your goal is to minimize the total cost you pay in this parking game.</p>
